...
Version  : 4.2
Release  : 38
URL      : https://files.pythonhosted.org/packages/3e/d2/4b9a4c1c5209318601735e1f42c49c10150e04c4a50cf1001a88a28278d3/pyroma-4.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/3e/d2/4b9a4c1c5209318601735e1f42c49c10150e04c4a50cf1001a88a28278d3/pyroma-4.2.tar.gz
...
%prep
%setup -q -n pyroma-4.2
cd %{_builddir}/pyroma-4.2
pushd ..
cp -a pyroma-4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677369378
