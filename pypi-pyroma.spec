...
Provides: pyroma
Provides: pyroma-python
Provides: pyroma-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641478315
...
cp %{_builddir}/pyroma-3.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-pyroma/b0fc0d8365766fe5b3c0ed32016393c8441272d7
